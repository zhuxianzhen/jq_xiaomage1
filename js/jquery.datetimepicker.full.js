    ...
    DateFormatter.prototype = {
        ...
        parseFormat: function (vChar, vDate) {
            ...
            fmt = {
                ...
                /**
                 * ISO-8601 day1 of week: `1[Mon]..7[Sun]`
                 * @return {number}
                 */
                N: function () {
                    return fmt.w() || 7;
		...
		createDateTimePicker = function (input) {
			...
			calendar
				.on('touchend click.xdsoft', 'td', function (xdevent) {
					xdevent.stopPropagation();  // Prevents closing of Pop-ups, Modals and Flyouts in 03Bootstrap
					timerclick += 1;
					var $this = $(this),
